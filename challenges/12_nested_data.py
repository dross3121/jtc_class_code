...
print(borough['airports'][0]['name'])
print(borough['airports'][1]['name'])
...
for borough in nyc:
    if "parks" in borough:
        for park_name in borough['parks']:
            print('\t' + park_name['name'])
...
for borough in nyc:
    print(borough['name'])
    if places_input in borough:
        for places in borough[places_input]:
            print("\t" + places['name'])
