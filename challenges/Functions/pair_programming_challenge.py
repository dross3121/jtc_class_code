...
from pair_challenge_functions import *
...
deposit(my_account, float(100))
deposit(my_account, 878.0)
print(my_account)
'''
PART 3: withdraw()
...
withdraw(my_account, float(10))
withdraw(my_account, float(20.0))
