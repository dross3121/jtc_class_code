...
print('Question 5')
add_song(my_playlist, {'artist': 'Maxwell', 'title': "Something Something"})

add_song(my_playlist, {'artist': 'Kem', 'title': "You don't have to lie to me"})
...
a =(get_playlist_length(my_playlist))
print(a)
...
# plays_ran = np.mean(monthly_plays)
